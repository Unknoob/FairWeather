...
class WeatherViewController: ViewCodeController {
    ...
    override func setupConstraints() {
        view.addConstraints([
            ...
            iconTemperatureContainerView.topAnchor.constraint(
            ...
            currentWeatherLabel.topAnchor.constraint(
                equalTo: iconTemperatureContainerView.bottomAnchor,
                constant: Spacing.small
            ),

            minimumMaximumTemperatureContainerView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            minimumMaximumTemperatureContainerView.topAnchor.constraint(
                equalTo: currentWeatherLabel.bottomAnchor,
                constant: Spacing.small
            ),

            minimumTemperatureLabel.bottomAnchor.constraint(
                equalTo: minimumMaximumTemperatureContainerView.bottomAnchor
            ),
            ...
            maximumTemperatureLabel.bottomAnchor.constraint(
                equalTo: minimumMaximumTemperatureContainerView.bottomAnchor
            ),
            maximumTemperatureLabel.leftAnchor.constraint(
                equalTo: minimumTemperatureLabel.rightAnchor,
                constant: Spacing.small
            )
        ])
    }
